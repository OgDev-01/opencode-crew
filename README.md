...
>
> **opencode-crew.com is NOT affiliated with this project.** We do not operate or endorse that site.
>
> OpenCodeCrew is **free and open-source**. Do **not** download installers or enter payment details on third-party sites that claim to be "official."
>
...
>
> ✅ Official downloads: https://github.com/buldtech/opencode-crew/releases

> [!TIP]
> Be with us!
>
> | [<img alt="Discord link" src="https://img.shields.io/discord/1452487457085063218?color=5865F2&label=discord&labelColor=black&logo=discord&logoColor=white&style=flat-square" width="156px" />](https://discord.gg/PUwSMR9XNk) | Join our [Discord community](https://discord.gg/PUwSMR9XNk) to connect with contributors and fellow `opencode-crew` users. |
> | :-----| :----- |
> | [<img alt="GitHub Follow" src="https://img.shields.io/github/followers/buldtech?style=flat-square&logo=github&labelColor=black&color=24292f" width="156px" />](https://github.com/buldtech) | Follow [@buldtech](https://github.com/buldtech) on GitHub for more projects. |

<!-- <CENTERED SECTION FOR GITHUB DISPLAY> -->

<div align="center">

[![OpenCodeCrew](./.github/assets/hero.jpg)](https://github.com/buldtech/opencode-crew#opencode-crew)

[![Preview](./.github/assets/omo.png)](https://github.com/buldtech/opencode-crew#opencode-crew)
...
[![GitHub Release](https://img.shields.io/github/v/release/buldtech/opencode-crew?color=369eff&labelColor=black&logo=github&style=flat-square)](https://github.com/buldtech/opencode-crew/releases)
[![npm downloads](https://img.shields.io/npm/dt/@buldtech/opencode-crew?color=ff6b35&labelColor=black&style=flat-square)](https://www.npmjs.com/package/@buldtech/opencode-crew)
[![GitHub Contributors](https://img.shields.io/github/contributors/buldtech/opencode-crew?color=c4f042&labelColor=black&style=flat-square)](https://github.com/buldtech/opencode-crew/graphs/contributors)
[![GitHub Forks](https://img.shields.io/github/forks/buldtech/opencode-crew?color=8ae8ff&labelColor=black&style=flat-square)](https://github.com/buldtech/opencode-crew/network/members)
[![GitHub Stars](https://img.shields.io/github/stars/buldtech/opencode-crew?color=ffcb47&labelColor=black&style=flat-square)](https://github.com/buldtech/opencode-crew/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/buldtech/opencode-crew?color=ff80eb&labelColor=black&style=flat-square)](https://github.com/buldtech/opencode-crew/issues)
[![License](https://img.shields.io/badge/license-SUL--1.0-white?labelColor=black&style=flat-square)](https://github.com/buldtech/opencode-crew/blob/dev/LICENSE.md)
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/buldtech/opencode-crew)
...
> "If Claude Code does in 7 days what a human does in 3 months, Captain does it in 1 hour. It just works until the task is done. It is a discipline agent." <br/>- B, Quant Researcher

> "Knocked out 8000 eslint warnings with opencode-crew, just in a day" <br/>- [Jacob Ferrari](https://x.com/jacobferrari_/status/2003258761952289061)

> "I converted a 45k line tauri app into a SaaS web app overnight using opencode-crew and ralph loop. Started with interview me prompt, asked it for ratings and recommendations on the questions. It was amazing to watch it work and to wake up this morning to a mostly working website!" - [James Hargis](https://x.com/hargabyte/status/2007299688261882202)

> "use opencode-crew, you will never go back" <br/>- [d0t3ch](https://x.com/d0t3ch/status/2001685618200580503)

> "I haven't really been able to articulate exactly what makes it so great yet, but the development experience has reached a completely different dimension." - [
苔硯:こけすずり](https://x.com/kokesuzuri/status/2008532913961529372?s=20)

> "Experimenting with open code, opencode-crew and supermemory this weekend to build some minecraft/souls-like abomination."
...
> "opencode-crew Is Actually Insane" - [YouTube - Darren Builds AI](https://www.youtube.com/watch?v=G_Snfh2M41M)
...
Install Crew. Type `ultrawork`. Done.
...
```bash
curl -s https://raw.githubusercontent.com/buldtech/opencode-crew/refs/heads/dev/docs/guide/installation.md
```
...
```
Read this and tell me why it's not just another boilerplate: https://raw.githubusercontent.com/buldtech/opencode-crew/refs/heads/dev/README.md
```
...
| :---: | :------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   🤖   | **Discipline Agents**                                    | Captain orchestrates Craftsman, Sage, Archivist, Lookout. A full AI dev team in parallel.                                                      |
...
|   📋   | **Strategist Planner**                                   | Interview-mode strategic planning before any execution.                                                                                                                                                          |
...
<table><tr>
<td align="center"><img src=".github/assets/captain.png" height="300" /></td>
<td align="center"><img src=".github/assets/craftsman.png" height="300" /></td>
</tr></table>

**Captain** (`claude-opus-4-6` / **`kimi-k2.5`** / **`glm-5`** ) is your main orchestrator. He plans, delegates to specialists, and drives tasks to completion with aggressive parallel execution. He does not stop halfway.

**Craftsman** (`gpt-5.3-codex`) is your autonomous deep worker. Give him a goal, not a recipe. He explores the codebase, researches patterns, and executes end-to-end without hand-holding. *The Legitimate Craftsman.*

**Strategist** (`claude-opus-4-6` / **`kimi-k2.5`** / **`glm-5`** ) is your strategic planner. Interview mode: it questions, identifies scope, and builds a detailed plan before a single line of code is touched.

Every agent is tuned to its model's specific strengths. No manual model-juggling. [Learn more →](docs/guide/overview.md)

> Anthropic [blocked OpenCode because of us.](https://x.com/thdxr/status/2010149530486911014) That's why Craftsman is called "The Legitimate Craftsman." The irony is intentional.
>
> We run best on Opus, but Kimi K2.5 + GPT-5.3 Codex already beats vanilla Claude Code. Zero config needed.

### Agent Orchestration

When Captain delegates to a subagent, it doesn't pick a model. It picks a **category**. The category maps automatically to the right model:
...
`/start-work` calls Strategist. **Interviews you like a real engineer**, identifies scope and ambiguities, builds a verified plan before touching code. Agent knows what it's building before it starts.
...
> **New to opencode-crew?** Read the **[Overview](docs/guide/overview.md)** to understand what you have, or check the **[Orchestration Guide](docs/guide/orchestration.md)** for how agents collaborate.

## Uninstallation

To remove opencode-crew:

1. **Remove the plugin from your OpenCode config**

Edit `~/.config/opencode/opencode.json` (or `opencode.jsonc`) and remove `"opencode-crew"` from the `plugin` array:

```bash
# Using jq
jq '.plugin = [.plugin[] | select(. != "opencode-crew")]' \
...
```bash
# Remove user config
rm -f ~/.config/opencode/opencode-crew.json ~/.config/opencode/opencode-crew.jsonc

# Remove project config (if exists)
rm -f .opencode/opencode-crew.json .opencode/opencode-crew.jsonc
```
...
**Quick Overview:**
- **Agents**: Captain (the main agent), Strategist (planner), Sage (architecture/debugging), Archivist (docs/code search), Lookout (fast codebase grep), Spotter
...
**Quick Overview:**
- **Config Locations**: `.opencode/opencode-crew.jsonc` or `.opencode/opencode-crew.json` (project), `~/.config/opencode/opencode-crew.jsonc` or `~/.config/opencode/opencode-crew.json` (user)
- **JSONC Support**: Comments and trailing commas supported
- **Agents**: Override models, temperatures, prompts, and permissions for any agent
- **Built-in Skills**: `playwright` (browser automation), `git-master` (atomic commits)
- **Captain Agent**: Main orchestrator with Strategist (Planner) and Assessor (Plan Consultant)
...
If OpenCode is Debian/Arch, Crew is Ubuntu/[Omarchy](https://omarchy.org/).
...
Acknowledgments: opencode-crew is built upon the foundation of [oh-my-opencode](https://github.com/sgomez/oh-my-opencode) — an outstanding OpenCode plugin that pioneered the multi-agent orchestration patterns used here. We are grateful for their work and the inspiration it provided for this project.
