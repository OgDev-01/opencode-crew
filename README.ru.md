...
>
> **opencode-crew.com НЕ аффилирован с этим проектом.** Мы не управляем этим сайтом и не одобряем его.
>
> OpenCodeCrew — **бесплатный и открытый проект**. Не скачивайте установщики и не вводите платёжные данные на сторонних сайтах, которые называют себя «официальными».
>
...
>
> ✅ Официальные загрузки: https://github.com/buldtech/opencode-crew/releases

> [!TIP] Будьте с нами!
>
> | [](https://discord.gg/PUwSMR9XNk)   | Вступайте в наш [Discord](https://discord.gg/PUwSMR9XNk), чтобы общаться с контрибьюторами и пользователями `opencode-crew`. |
> | ----------------------------------- | ------------------------------------------------------------ |
> | [](https://github.com/buldtech) | Подпишитесь на [@buldtech](https://github.com/buldtech) на GitHub, чтобы следить за другими проектами. |
...
[![GitHub Release](https://img.shields.io/github/v/release/buldtech/opencode-crew?color=369eff&labelColor=black&logo=github&style=flat-square)](https://github.com/buldtech/opencode-crew/releases) [![npm downloads](https://img.shields.io/npm/dt/@buldtech/opencode-crew?color=ff6b35&labelColor=black&style=flat-square)](https://www.npmjs.com/package/@buldtech/opencode-crew) [![GitHub Contributors](https://img.shields.io/github/contributors/buldtech/opencode-crew?color=c4f042&labelColor=black&style=flat-square)](https://github.com/buldtech/opencode-crew/graphs/contributors) [![GitHub Forks](https://img.shields.io/github/forks/buldtech/opencode-crew?color=8ae8ff&labelColor=black&style=flat-square)](https://github.com/buldtech/opencode-crew/network/members) [![GitHub Stars](https://img.shields.io/github/stars/buldtech/opencode-crew?color=ffcb47&labelColor=black&style=flat-square)](https://github.com/buldtech/opencode-crew/stargazers) [![GitHub Issues](https://img.shields.io/github/issues/buldtech/opencode-crew?color=ff80eb&labelColor=black&style=flat-square)](https://github.com/buldtech/opencode-crew/issues) [![License](https://img.shields.io/badge/license-SUL--1.0-white?labelColor=black&style=flat-square)](https://github.com/buldtech/opencode-crew/blob/master/LICENSE.md) [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/buldtech/opencode-crew)
...
> «Если Claude Code делает за 7 дней то, на что у человека уходит 3 месяца, Captain справляется за 1 час. Он просто работает, пока задача не выполнена. Это дисциплинированный агент.» <br/>— B, исследователь в области квантовых финансов

> «За один день устранил 8000 предупреждений eslint с помощью opencode-crew.» <br/>— [Jacob Ferrari](https://x.com/jacobferrari_/status/2003258761952289061)

> «За ночь конвертировал приложение на tauri в 45k строк в веб-SaaS с помощью opencode-crew и ralph loop. Начал с промпта «проинтервьюируй меня», попросил оценки и рекомендации по вопросам. Было удивительно наблюдать за работой и утром проснуться с почти рабочим сайтом!» — [James Hargis](https://x.com/hargabyte/status/2007299688261882202)

> «Используйте opencode-crew — вы не захотите возвращаться назад.» <br/>— [d0t3ch](https://x.com/d0t3ch/status/2001685618200580503)
...
> «Экспериментирую с open code, opencode-crew и supermemory этим выходным, чтобы собрать нечто среднее между Minecraft и souls-like.» «Попросил добавить анимации приседания, пока хожу на обеденную прогулку. [Видео]» — [MagiMetal](https://x.com/MagiMetal/status/2005374704178373023)
...
> «opencode-crew — это что-то с чем-то» — [YouTube — Darren Builds AI](https://www.youtube.com/watch?v=G_Snfh2M41M)
...
Установите Crew. Введите `ultrawork`. Готово.
...
|      | Функция                                                  | Что делает                                                   |
| ---- | -------------------------------------------------------- | ------------------------------------------------------------ |
| 🤖    | **Дисциплинированные агенты**                            | Captain оркестрирует Craftsman, Sage, Archivist, Lookout. Полноценная AI-команда разработки в параллельном режиме. |
...
| 📋    | **Strategist Planner**                                   | Стратегическое планирование в режиме интервью перед любым выполнением. |
...
<table><tr> <td align="center"><img src=".github/assets/captain.png" height="300" /></td> <td align="center"><img src=".github/assets/craftsman.png" height="300" /></td> </tr></table>

**Captain** (`claude-opus-4-6` / **`kimi-k2.5`** / **`glm-5`**) — главный оркестратор. Он планирует, делегирует задачи специалистам и доводит их до завершения с агрессивным параллельным выполнением. Он не останавливается на полпути.

**Craftsman** (`gpt-5.3-codex`) — автономный глубокий исполнитель. Дайте ему цель, а не рецепт. Он исследует кодовую базу, изучает паттерны и выполняет задачи сквозным образом без лишних подсказок. *Законный Мастер.*

**Strategist** (`claude-opus-4-6` / **`kimi-k2.5`** / **`glm-5`**) — стратегический планировщик. Режим интервью: задаёт вопросы, определяет объём работ и формирует детальный план до того, как написана хотя бы одна строка кода.

Каждый агент настроен под сильные стороны своей модели. Никакого ручного переключения между моделями. Подробнее →

> Anthropic [заблокировал OpenCode из-за нас.](https://x.com/thdxr/status/2010149530486911014) Именно поэтому Craftsman зовётся «Законным Мастером». Ирония намеренная.
>
...
Когда Captain делегирует задачу субагенту, он выбирает не модель, а **категорию**. Категория автоматически сопоставляется с нужной моделью:
...
### Планирование. Strategist

Сложная задача? Не нужно молиться и надеяться на промпт.

`/start-work` вызывает Strategist. **Интервьюирует вас как настоящий инженер**, определяет объём работ и неоднозначности, формирует проверенный план до прикосновения к коду. Агент знает, что строит, прежде чем начать.
...
> **Впервые в opencode-crew?** Прочитайте **Обзор**, чтобы понять, что у вас есть, или ознакомьтесь с **руководством по оркестрации**, чтобы узнать, как агенты взаимодействуют.

## Удаление

Чтобы удалить opencode-crew:

1. **Удалите плагин из конфига OpenCode**

Отредактируйте `~/.config/opencode/opencode.json` (or `opencode.jsonc`) и уберите `"opencode-crew"` из массива `plugin`:
...
- **Агенты**: Captain (главный агент), Strategist (планировщик), Oracle (архитектура/отладка), Librarian (документация/поиск по коду), Explore (быстрый grep по кодовой базе), Multimodal Looker
...
- **Расположение конфигов**: `.opencode/opencode-crew.jsonc` or `.opencode/opencode-crew.json` (проект), `~/.config/opencode/opencode-crew.jsonc` or `~/.config/opencode/opencode-crew.json` (пользователь)
...
- **Агент Captain**: Главный оркестратор с Strategist (Планировщик) and Assessor (Консультант по плану)
...
Если OpenCode — это Debian/Arch, то Crew — это Ubuntu/[Omarchy](https://omarchy.org/).
