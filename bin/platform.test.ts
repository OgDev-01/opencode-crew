...
describe("getBinaryPath", () => {
  test("returns path without .exe for Unix platforms", () => {
    ...
    const pkg = "opencode-crew-darwin-arm64";
    ...
    expect(result).toBe("opencode-crew-darwin-arm64/bin/opencode-crew");
  });

  test("returns path with .exe for Windows", () => {
    // #given Windows platform package
    const pkg = "opencode-crew-windows-x64";
    ...
    expect(result).toBe("opencode-crew-windows-x64/bin/opencode-crew.exe");
  });

  test("returns path without .exe for Linux", () => {
    // #given Linux platform package
    const pkg = "opencode-crew-linux-x64";
    ...
    // #then returns path without extension
    expect(result).toBe("opencode-crew-linux-x64/bin/opencode-crew");
  });
});
