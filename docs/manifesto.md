...
### Approach 1: Strategist (Interview Mode)
...
- Escalation (to Sage, to user) only when truly needed
...
| Feature | Purpose |
|---------|---------|
| Strategist | Extract intent through intelligent interview |
| Assessor | Catch ambiguities before they become bugs |
| Critic | Verify plans are complete before execution |
