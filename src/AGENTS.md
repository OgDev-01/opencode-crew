...
| File | Purpose |
|------|---------|
| `index.ts` | Plugin entry, exports `OpenCodeCrewPlugin` |
...
loadPluginConfig(directory, ctx)
  1. User: ~/.config/opencode/opencode-crew.jsonc
  2. Project: .opencode/opencode-crew.jsonc
...
createHooks()
  ...
  │   ├─ createSessionHooks()     # 23: contextWindowMonitor, thinkMode, ralphLoop, modelFallback, runtimeFallback, noCaptainGpt, noCraftsmanNonGpt, anthropicEffort...
  ...
  ├─→ createContinuationHooks()   # 7: todoContinuationEnforcer, relay, stopContinuationGuard...
