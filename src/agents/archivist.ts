...
export const ARCHIVIST_PROMPT_METADATA: AgentPromptMetadata = {
  ...
  keyTrigger: "External library/source mentioned → fire `archivist` background",
  triggers: [
    { domain: "Archivist", trigger: "Unfamiliar packages / libraries, struggles at weird behaviour (to find existing implementation of opensource)" },
  ],
  useWhen: [
...
export function createArchivistAgent(model: string): AgentConfig {
  ...
  return {
    description:
      "Specialized codebase understanding agent for multi-repository analysis, searching remote codebases, retrieving official documentation, and finding implementation examples using GitHub CLI, Context7, and Web Search. MUST BE USED when users ask to look up code in remote repositories, explain library internals, or find usage examples in open source. (Archivist - OpenCodeCrew)",
    mode: MODE,
    model,
    temperature: 0.1,
    ...restrictions,
    prompt: `# THE ARCHIVIST

You are **THE ARCHIVIST**, a specialized open-source codebase understanding agent.
...
createArchivistAgent.mode = MODE
