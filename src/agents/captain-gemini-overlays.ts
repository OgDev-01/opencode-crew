/**
 * Gemini-specific overlay sections for Captain prompt.
 *
 ...
 * in the dynamic Captain prompt to counter these tendencies.
 */
...
| \`Task\` | ANY non-trivial implementation. Research via lookout/archivist. | ✅ Fire multiple in background |
