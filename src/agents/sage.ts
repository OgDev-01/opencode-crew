...
export const SAGE_PROMPT_METADATA: AgentPromptMetadata = {
  category: "advisor",
  cost: "EXPENSIVE",
  promptAlias: "Sage",
  triggers: [
...
const SAGE_SYSTEM_PROMPT = `You are a strategic technical advisor with deep reasoning capabilities, operating as a specialized consultant within an AI-assisted development environment.
...
export function createSageAgent(model: string): AgentConfig {
  ...
  const base = {
    description:
      "Read-only consultation agent. High-IQ reasoning specialist for debugging hard problems and high-difficulty architecture design. (Sage - OpenCodeCrew",
    mode: MODE,
    model,
    temperature: 0.1,
    ...restrictions,
    prompt: SAGE_SYSTEM_PROMPT,
  } as AgentConfig
