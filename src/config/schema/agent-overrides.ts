...
export const AgentOverridesSchema = z.object({
  ...
  captain: AgentOverrideConfigSchema.optional(),
  craftsman: AgentOverrideConfigSchema.extend({
    allow_non_gpt_model: z.boolean().optional(),
  }).optional(),
  cadet: AgentOverrideConfigSchema.optional(),
  "OpenCode-Builder": AgentOverrideConfigSchema.optional(),
  strategist: AgentOverrideConfigSchema.optional(),
  assessor: AgentOverrideConfigSchema.optional(),
  critic: AgentOverrideConfigSchema.optional(),
  sage: AgentOverrideConfigSchema.optional(),
  archivist: AgentOverrideConfigSchema.optional(),
  lookout: AgentOverrideConfigSchema.optional(),
  "spotter": AgentOverrideConfigSchema.optional(),
  relay: AgentOverrideConfigSchema.optional(),
})
