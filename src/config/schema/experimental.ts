...
export const ExperimentalConfigSchema = z.object({
  ...
  /** Truncate all tool outputs, not just whitelisted tools (default: true). Tool output truncator is enabled by default - disable via disabled_hooks. */
  ...
  /** Disable auto-injected <crew-env> context in prompts (experimental) */
  disable_crew_env: z.boolean().optional(),
