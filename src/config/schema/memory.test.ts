  ...
  describe("#given empty config object", () => {
    describe("#when parsing", () => {
      it("should apply all defaults", () => {
        ...
        expect(data.embedding_model).toBe("Xenova/all-MiniLM-L6-v2")
        ...
        expect(data.ttl_golden_rules_days).toBe(90)
        expect(data.ttl_heuristics_days).toBe(180)
        ...
        expect(data.delegation_cost_awareness).toBe(true)
      })
    })
  })
