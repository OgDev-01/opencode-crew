...
describe("boulder-state", () => {
  ...
  const CREW_DIR = join(TEST_DIR, ".crew")
  ...
  describe("readBoulderState", () => {
    ...
    test("should return null for JSON null value", () => {
      ...
      const boulderFile = join(CREW_DIR, "boulder.json")
  ...
  describe("writeBoulderState", () => {
    test("should write state and create .crew directory if needed", () => {
...
`)
  ...
  describe("getPlanName", () => {
    test("should extract plan name from path", () => {
      // given
      const path = "/home/user/.crew/plans/project/my-feature.md"
      // when
