...
import type { McpServerConfig, ClaudeCodeMcpConfig } from "@/shared/loader-types/mcp-types"
import { expandEnvVarsInObject } from "../claude-code-mcp-loader/env-expander" // EXCEPTION: plugin-loader orchestrates mcp-loader transforms
import { transformMcpServer } from "../claude-code-mcp-loader/transformer" // EXCEPTION: plugin-loader orchestrates mcp-loader transforms
