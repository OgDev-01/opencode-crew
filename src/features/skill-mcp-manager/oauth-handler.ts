import type { ClaudeCodeMcpServer } from "@/shared/loader-types/mcp-types"
import { McpOAuthProvider } from "../mcp-oauth/provider" // EXCEPTION: skill-mcp-manager orchestrates mcp-oauth for auth flow
import type { OAuthTokenData } from "../mcp-oauth/storage" // EXCEPTION: skill-mcp-manager orchestrates mcp-oauth for auth flow
import { isStepUpRequired, mergeScopes } from "../mcp-oauth/step-up" // EXCEPTION: skill-mcp-manager orchestrates mcp-oauth for auth flow
