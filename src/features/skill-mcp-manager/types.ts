...
import type { McpOAuthProvider } from "../mcp-oauth/provider" // EXCEPTION: skill-mcp-manager orchestrates mcp-oauth

export type { SkillMcpConfig } from "@/shared/loader-types/mcp-types"
