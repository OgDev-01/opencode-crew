...
describe("createCompactionContextInjector", () => {
  ...
  describe("Delegated Agent Sessions", () => {
    ...
    it("injects actual task history when backgroundManager and sessionID provided", async () => {
      ...
      mockManager.taskHistory.record("ses_parent", { id: "t1", sessionID: "ses_child", agent: "lookout", description: "Find patterns", status: "completed", category: "quick" })
      ...
      expect(prompt).toContain("**lookout**")
