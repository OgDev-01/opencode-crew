...
import { isSystemDirective,
removeSystemReminders, } from "@/shared/hook-utils/system-directive"
import {
  getMainSessionID,
  getSessionAgent,
  subagentSessions,
...
export function createKeywordDetectorHook(ctx: PluginInput, _collector?: ContextCollector) {
  return {
    "chat.message": async (
      ...
      // (e.g., [analyze-mode]) which incorrectly triggers Strategist restrictions
