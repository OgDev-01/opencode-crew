...
import { readConnectedProvidersCache, readProviderModelsCache } from "@/shared/model/connected-providers-cache"
import { selectFallbackProvider } from "@/shared/model/model-error-classifier"
...
} from "@/shared/session/session-fallback-chain"
...
export { setSessionFallbackChain, clearSessionFallbackChain }
...
export function setPendingModelFallback(
  ...
  const sessionFallback = getSessionFallbackChain(sessionID)
