...
import { applyMemoryConfig } from "./plugin-handlers"

const OpenCodeCrewPlugin: Plugin = async (ctx) => {
  log("[OpenCodeCrewPlugin] ENTRY - plugin loading", {
  ...
  applyMemoryConfig(pluginConfig, ctx.directory)
...
export default OpenCodeCrewPlugin
...
export type { ConfigLoadError } from "./shared/config/config-errors"
