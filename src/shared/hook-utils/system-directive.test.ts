...
<system-reminder>System info</system-reminder>`
  ...
  describe("isSystemDirective", () => {
    test("should return true for OPENCODE-CREW system directives", () => {
...
User wants to lookout the codebase and analyze the implementation.
...
Another system reminder with research keyword.
      ...
      const cleanText = removeSystemReminders(text)
      expect(cleanText).toContain("lookout")
