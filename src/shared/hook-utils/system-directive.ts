/**
 * Unified system directive prefix for opencode-crew internal messages.
 * All system-generated messages should use this prefix for consistent filtering.
 *
 * Format: [SYSTEM DIRECTIVE: OPENCODE-CREW - {TYPE}]
 */

export const SYSTEM_DIRECTIVE_PREFIX = "[SYSTEM DIRECTIVE: OPENCODE-CREW"

/**
 * Creates a system directive header with the given type.
 * @param type - The directive type (e.g., "TODO CONTINUATION", "RALPH LOOP")
 * @returns Formatted directive string like "[SYSTEM DIRECTIVE: OPENCODE-CREW - TODO CONTINUATION]"
 */
...
/**
 * Checks if a message starts with the opencode-crew system directive prefix.
...
export const SystemDirectiveTypes = {
  ...
  STRATEGIST_READ_ONLY: "STRATEGIST READ-ONLY",
} as const
