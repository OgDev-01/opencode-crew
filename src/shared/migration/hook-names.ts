...
export const HOOK_NAME_MAP: Record<string, string | null> = {
  ...
  "sisyphus-gpt-hephaestus-reminder": "no-captain-gpt",

  // Rebrand: old hook names → new hook names (opencode-crew rebrand)
  "prometheus-md-only": "strategist-md-only",
  "sisyphus-junior-notepad": "cadet-notepad",
  "no-sisyphus-gpt": "no-captain-gpt",
  "no-hephaestus-non-gpt": "no-craftsman-non-gpt",
