...
describe("resolveModelWithFallback", () => {
  ...
  describe("Step 3: Provider fallback chain", () => {
    ...
    test("cross-provider fuzzy match when preferred provider unavailable (archivist scenario)", () => {
  ...
  describe("Multi-entry fallbackChain", () => {
    test("resolves to claude-opus when OpenAI unavailable but Anthropic available (sage scenario)", () => {
      // given
