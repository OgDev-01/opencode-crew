...
import { truncateDescription } from "@/shared/string-transform/truncate-description"
import { CATEGORY_DESCRIPTIONS } from "@/shared/agent"
export { CATEGORY_DESCRIPTIONS }
...
4. If unsure about style, lookout more files until you find the pattern
...
- Lookout radical, unconventional directions
...
1. SILENTLY lookout the codebase extensively (5-15 minutes of reading is normal)
...
**Approach**:
- Lookout extensively, understand deeply, then act decisively
...
export { DEFAULT_CATEGORIES } from "@/shared/config/default-categories"
 ...
 * Instructs the plan agent to first gather context via lookout/archivist agents,
...
1. Launch background agents to gather context:
   - call_agent(description="Lookout codebase patterns", subagent_type="lookout", run_in_background=true, prompt="<search for relevant patterns, files, and implementations in the codebase related to user's request>")
   - call_agent(description="Research documentation", subagent_type="archivist", run_in_background=true, prompt="<search for external documentation, examples, and best practices related to user's request>")
