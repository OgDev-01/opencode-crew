...
import { AGENT_MODEL_REQUIREMENTS } from "@/shared/model/model-requirements"
import { getAgentDisplayName, getAgentConfigKey } from "@/shared/agent/agent-display-names"
...
export async function resolveSubagentExecution(
  ...
  if (agentName.toLowerCase() === CADET_AGENT.toLowerCase()) {
    return {
      agentToUse: "",
      categoryModel: undefined,
      error: `Cannot use subagent_type="${CADET_AGENT}" directly. Use category parameter instead (e.g., ${categoryExamples}).

Cadet is spawned automatically when you specify a category. Pick the appropriate category for your task domain.`,
    }
  }
