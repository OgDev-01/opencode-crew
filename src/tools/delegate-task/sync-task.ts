...
import { setSessionFallbackChain, clearSessionFallbackChain } from "@/shared/session/session-fallback-chain"
...
export async function executeSyncTask(
  ...
  fallbackChain?: import("../../shared/model/model-requirements").FallbackEntry[],
